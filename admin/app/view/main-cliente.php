					...
					<form id="form-cliente" role="form" >
						...
						<div class="form-group">
							...
							<div class="input-group margin-bottom-sm">
								...
								<input type="text" class="form-control" id="CPF_CNPJ" name="CPF_CNPJ" required minlength="11" onkeydown="Mask.mascara(this, Mask.mcpf)" maxlength="14">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="input-group margin-bottom-sm">
								...
								<input type="email" class="form-control" id="EMAIL" name="EMAIL" required minlength="3" maxlength="45">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="input-group margin-bottom-sm">
								...
								<input type="text" class="form-control" id="TELEFONE" name="TELEFONE" required minlength="8" onkeydown="Mask.mascara(this, Mask.mtelefone)" maxlength="16">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="input-group margin-bottom-sm">
								...
								<input type="text" class="form-control" id="RUA" name="RUA" required minlength="3" maxlength="45">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="input-group margin-bottom-sm">
								...
								<input type="text" class="form-control" id="NUMERO" name="NUMERO" required minlength="1" maxlength="6">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="input-group margin-bottom-sm">
							  	<span class="input-group-addon"><i class="fa fa-road fa-fw"></i></span>
								<input type="text" class="form-control" id="BAIRRO" name="BAIRRO" required minlength="3" maxlength="45">
							</div>
						</div>
						<div class="form-group">
