			...
			<div id="panel-medida" class="panel panel-default" style="display:none;" >
				<div class="panel-body">
					<form id="form-medida" role="form" >
						...
						<div class="form-group">
							<label for="DIMINUIR">cm Diminuir</label>
							<div class="input-group margin-bottom-sm">
						...
						<div class="form-group">
							<label for="AUMENTAR">cm Aumentar</label>
							<div class="input-group margin-bottom-sm">
						...
						<div class="form-group">
							...
							<div class="input-group margin-bottom-sm">
								...
								<input type="text" class="form-control" id="DIVIDIR" name="DIVIDIR" required minlength="1" >
							</div>
						</div>
						<div class="form-group">
		...
		<table id="table-medida" class="table table-bordered table-striped">
			<thead>
				<tr>
					...
					<th><label>cm Diminuir</label></th>
					<th><label>cm Aumentar</label></th>
